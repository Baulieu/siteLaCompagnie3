...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Lcb/VitrineBundle/Resources/config/doctrine') => 'Lcb\\VitrineBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Lcb\\VitrineBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('LcbVitrineBundle' => 'Lcb\\VitrineBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cff891f3742bc14573d802a80c65896faf7774979497e3e97d8f8ea65828d059');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '55a948e60f394', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login', false), NULL, NULL, $b));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Lcb/VitrineBundle/Resources/views'), 'LcbVitrine');
        $instance->addPath(($this->targetDirs[3].'/src/Lcb/UserBundle/Resources/views'), 'LcbUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ec22ea0307f0f391b9bb2c24ad5ce9d4f745baa4');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('Thorstein', 'biff', array(0 => 'ROLE_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('Olaf', 'oseille', array(0 => 'ROLE_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('Rollo', 'cash', array(0 => 'ROLE_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('Ragnar', 'thune', array(0 => 'ROLE_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('Baif', 'fric', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LcbVitrineBundle' => 'Lcb\\VitrineBundle\\LcbVitrineBundle',
                'LcbUserBundle' => 'Lcb\\UserBundle\\LcbUserBundle',
            ...
            'locale' => 'en',
            'secret' => 'ec22ea0307f0f391b9bb2c24ad5ce9d4f745baa4',
            ...
            'kernel.secret' => 'ec22ea0307f0f391b9bb2c24ad5ce9d4f745baa4',
